...
<div id="left_ctn">
    <ul class="sidenav">
        ...
        <li>
            ...
            <ul class="erji">
                <li>
                    <span><a href="log/operationLoglist.do" target="main">操作日志</a></span>
                </li>
                <li>
                    <span><a href="log/loginLoglist.do" target="main">登录日志</a></span>
                </li>
                <li>
                    <span><a href="log/systemLoglist.do" target="main">系统日志</a></span>
                </li>
            </ul>
        </li>
        <li>
            <div class="nav_m">
                <span><a href="loginout.do" target="_top">退出系统</a></span>
            </div>
        </li>
    </ul>
</div>
