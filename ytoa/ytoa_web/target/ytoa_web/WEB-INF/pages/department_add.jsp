                ...
                <form:form action="/department/add" modelAttribute="department"  id="admin-form" name="addForm">
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="dname" class="field prepend-icon">
                                    <!--path="dname"表示id="dname"和 name="dname"-->
                                    <form:input path="dname" cssClass="gui-input" placeholder="编号..."/>
                                    <label for="dname" class="field-icon">
