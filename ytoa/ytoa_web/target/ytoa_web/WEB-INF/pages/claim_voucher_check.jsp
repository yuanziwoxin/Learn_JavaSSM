            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-4">${claimVoucher.nextDealer.name}</div>
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-3">费用类型：${item.item}</div>
                        <div class="col-md-3">金额：${item.amount}元</div>
                        <div class="col-md-5">说明：${item.comment}</div>
                        </c:forEach>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">总金额：${claimVoucher.totalAmount}元</div>
                    </div>
                    <div class="section-divider mt20 mb40">
                        <span> 处理流程 </span>
                    </div>
                    <div class="section row">
                    <c:forEach items="${dealRecords}" var="record">
                        <div class="col-md-1">${record.dealer.name}</div>
                        <%--利用spring:eval的方式显示时间--%>
                    ...
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="dRecord">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                <%--SessionCope:${sessionScope.employee.post}--%>
                                <%--Constant:${Constant.POST_FM}--%>
